...
path = "/zhome/11/1/193832/resquivel/RL/Training_notebooks/data/carpole/qlearning/"
...
# for alpha in alphas:
#     print(f"Alpha = {alpha}")
#     agent = Qlearning(environment_name, episodes, epsilon = 0.2, alpha= alpha, gamma= 0.95, adj_param='alpha')
#     agent.train()
...
#     agent = Qlearning(environment_name, episodes, epsilon = epsilon, alpha= 0.7, gamma= 0.95, adj_param='epsilon')
#     agent.train()
...
# for gamma in gammas:
#     print(f"gamma = {gamma}")
#     agent = Qlearning(environment_name, episodes, epsilon = 0.3, alpha= 0.7, gamma= gamma, adj_param='gamma')
#     agent.train()
#     save_object(agent,gamma,'gamma')
    
# for agent_n in range(10):
#     print(f"agent = {agent_n}")
#     agent = Qlearning(environment_name, episodes, epsilon = 0.3, alpha= 0.7, gamma= 0.95, adj_param='test')
#     agent.train()
#     save_object(agent,agent_n,'agent')

for agent_n in range(10):
    print(f"agent = {agent_n}")
    agent = Qlearning(environment_name, episodes, epsilon = 0.3, alpha= 0.5, gamma= 1, adj_param='test_gen')
    agent.train()
